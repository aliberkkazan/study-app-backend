...
export class StudyProfileController {
  ...
  @ApiResponse({
    status: 200,
    description: 'User study profile',
    type: StudyProfile,
  })
  ...
  @ApiResponse({
    status: 201,
    description: 'Study profile saved',
    type: StudyProfile,
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Study profile updated',
    type: StudyProfile,
  })
  async updateProfile(
    @CurrentUser() user: User,
  ...
  @Get('diagnostics')
  @ApiOperation({
    summary: 'Get all diagnostic/mock test results of current user',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiResponse({
    status: 201,
    description: 'Diagnostic result saved',
    type: DiagnosticResult,
  })
  async addDiagnostic(
    @CurrentUser() user: User,
