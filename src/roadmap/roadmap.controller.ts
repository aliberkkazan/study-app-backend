...
export class RoadmapController {
  ...
  @Get('current')
  @ApiOperation({
    summary: 'Get active roadmap and weekly curriculum items for current user',
  })
  @ApiResponse({
    status: 200,
    description: 'Active roadmap structure',
    type: Roadmap,
  })
  ...
  @Post('generate')
  @ApiOperation({
    summary: 'Generate a personalized weekly roadmap based on study profile',
  })
  @ApiResponse({
    status: 201,
    description: 'Newly generated roadmap',
    type: Roadmap,
  })
  ...
  @Post('replan')
  @ApiOperation({
    summary: 'Replan active roadmap redistributing missed/pending items',
  })
  @ApiResponse({
    status: 200,
    description: 'Updated roadmap after replanning',
    type: Roadmap,
  })
  async replanRoadmap(
    @CurrentUser() user: User,
  ...
  @Patch('items/:id')
  @ApiOperation({
    summary: 'Update status or details of a specific roadmap item',
  })
  @ApiResponse({
    status: 200,
    description: 'Updated roadmap item',
    type: RoadmapItem,
  })
  ...
  @ApiOperation({
    summary:
      'Convert a roadmap item into an active daily task in Today/Upcoming list',
  })
  @ApiResponse({
    status: 201,
    description: 'Roadmap item converted and linked to Task',
  })
  async convertItemToTask(@CurrentUser() user: User, @Param('id') id: string) {
